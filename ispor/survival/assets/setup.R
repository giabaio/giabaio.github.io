...
hspace=function(space="10px") {
  paste('<span style=display:inline-block; margin-left:',space,';"></span>')
}
...
samptux=function(path="assets/logo.png",width="2.0%",text="") {
  paste0('<span><a href="https://gianluca.statistica.it/"><img src="',path,'" title="Visit my website" width="',width,'"></a>',text,'</span>')
...
add_twitter=function() {
  paste0('&nbsp;<a href="https://twitter.com/giabaio"; title="Follow me on Twitter">',icons::icon_style(icons::fontawesome("twitter"),scale=.8,fill="#bcc0c4",bottom="1em"),'</a>&nbsp;')
}
add_email=function() {
